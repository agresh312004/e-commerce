    ...
    <main class="card" aria-labelledby="welcomeTitle">
      <section class="left">
        <div class="brand" aria-label="Brand">
          <div class="logo-text">Login Admin Password</div>
 
        </div>
         <form class="form" id="loginForm"  action="AdminLog2.jsp">
          <label class="input">
            ...
            <input type="email" placeholder="Your Email Address" required aria-label="Email address" name="Email" />
          ...
          <label class="input">
            ...
            <input id="pwdLogin" type="password" placeholder="Password"  name="Password" required aria-label="Password" />
