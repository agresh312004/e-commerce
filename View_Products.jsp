        ...
        <%
            ...
            if (session == null || session.getAttribute("Email") == null) {
                ...
                try {
                    ...
                    String query = "SELECT Name, Category, Quantity, Image_Name, Image_Path, Price, Expiry FROM seller_" + sellerSafe;
                            ...
                            while (rs.next()) {
                                ...
                                String fullPath = imagePath + "/" + imageName; // Photos/sellerFolder/image.jpg
                %>
