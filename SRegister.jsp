...
<html lang="en">
<head>
  <title>Seller Center ? Login/Register</title>
    ...
    <main class="card" aria-labelledby="welcomeTitle">
      <section class="left">
        <div class="brand" aria-label="Brand">
          <div class="logo-text">Your Growth, Our Mission.</div>
          <span class="badge">Happy Earning</span>
        </div>
        <form action="Sellerlog.jsp">
        <div class="tabs">
          <button class="btn" type="submit">Login</button>  
          <div class="tab active" data-tab="Register">Register</div>
          </div>
         </form>
         <form class="form" id="registerForm" action =" SellerReg2.jsp" onsubmit="validatePasswords(event)">
          <label class="input">
        ...
        errorBox.style.display = "block";
          ...
          <label class="input">
            ...
            <button class="peek" type="button" onclick="togglePwd('pwdRegister2', this)"><svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8S1 12 1 12z"/><circle cx="12" cy="12" r="3"/></svg></button>
          </label>
