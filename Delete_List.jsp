    ...
    <style>
        ...
        body {
            ...
            background: url('4aa8f45f74b347302309da315df7ce2d.jpg') no-repeat center center/cover, 
                        linear-gradient(135deg, #2193b0, #6dd5ed); /* Layered background image and gradient */
            margin: 0;
            padding: 0;
            display: flex;
...
<div class="container">
   ...
   <div class="scrollable">
    ...
    <form action="Delete_Product_database.jsp" method="get">
        <div class="product-card">
            ...
            <input type="hidden" name="id" value="<%= id %>"><br>
             <input type="hidden" name="imagePath" value="<%= fullPath %>">  
            <button type="submit" style="padding:8px 15px; border:none; background-color:#2193b0; color:white; border-radius:8px; cursor:pointer;" >🗑️ Delete</button>
              </p>
                </div>
        </div>
    </form>
