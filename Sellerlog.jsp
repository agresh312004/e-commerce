    ...
    <main class="card" aria-labelledby="welcomeTitle">
      <section class="left">
        <div class="brand" aria-label="Brand">
          ...
          <span class="badge">SELLER CENTER</span>
        </div>
        ...
        <!-- LOGIN FORM -->
        <form class="form" id="loginForm" action="SellerLog2.jsp">
          <label class="input">
            <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="4" width="20" height="16" rx="3"/><path d="M22 7L12 13 2 7"/></svg>
            <input type="email" name="N1" placeholder="Your Email Address" required />
          </label>
          <label class="input">
            ...
            <input id="pwdLogin" name="N2" type="password" placeholder="Password" required />
          </label>
          <div class="actions">
